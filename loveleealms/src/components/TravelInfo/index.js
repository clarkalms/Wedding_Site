				...
				<Row>
					<Col size="l12 m12 s12 travel-info-col">
						...
						<p className="info-content">
							When traveling to Italy, there are some travel sites we like to
							use to find great deals. Sometimes it can take a bit of shopping
							around to find the deals but below are some links of places to
							start:
						</p>
					...
					<Col size="l12 m12 s12 travel-info-col">
						...
						<p className="info-content">
							There are many other great places to stay in Florence and the
							Tuscan countryside. If you are looking to stay in the City of
							Florence, we reccommend using{' '}
							<a
								className="travel-link"
						...
						<p className="info-content">
							If you decide to stay in the city, we will be providing a shuttle
							to and from the Villa on the day of the wedding. We will update
							you with the time and location of shuttle pick-up and drop-off
							closer to June, 2021.
						</p>
					</Col>
					<Col size="l12 m12 s12 travel-info-col">
						...
						<p className="info-content">
							...
							non-stop), tickets to cities other than Florence tend to be
							cheaper. For our trips, we have flown into Rome and taken a €25
							roundtrip train ride into Florence. This helps save on costs and
							is a scenic trip though Tuscany.
						</p>
						<p className="info-content">
						...
						<p className="info-content">
							...
							from experience to bring an insect repelent and/or anti-itch
							cream. There will be special candles out to deter these unwanted
							visitors, but the venue is outdoors in the countryside.
						</p>
						<p className="info-content">
					...
					<Col size="l12 m12 s12 travel-info-col">
						...
						<p className="info-content">
							...
							getting around are walking and taking taxis. If you are planning
							on exploring at all, be sure to bring comfortable shoes (Clark
							will never make the mistake of choosing the wrong shoes again...).
						</p>
						<p className="info-content">
							...
							tickets. You can also download the app for your phone. Train
							tickets are usually cheaper the earlier you purchase them.
						</p>
					</Col>
				</Row>
			</Container>
